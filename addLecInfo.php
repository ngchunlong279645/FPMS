   ...
   try {
      ...
      if (file_exists($_FILES["fileToUpload"]["tmp_name"]) || is_uploaded_file($_FILES["fileToUpload"]["tmp_name"])) {
        ...
        echo "<script>window.location.replace('lecturer.php')</script>";
     	...
     	echo "<script>window.location.replace('addLecInfo.php')</script>";
  }
...
<div class="w3-content w3-padding-32">
        <form class="w3-card w3-padding" action="addLecInfo.php" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
