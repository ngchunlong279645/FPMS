...
if (isset($_POST['submit'])) {
  ...
  echo $sqladdproject = "INSERT INTO `tbl_projects`(`project_id`, `project_title`, `project_requirement`, `project_supervisor`, `project_description`, `project_start`, `project_end`) 
  VALUES ('$project_id','$project_title','$project_requirement','$project_supervisor','$project_description','$project_start','$project_end')";
        ...
        <div class="w3-row">
          ...
          <div class="w3-half" style="padding-right:4px">
            <p>
              ...
              <input class="w3-input w3-border w3-round" name="supervisor" type="text" required>
            </p>
          </div>
