...
if (isset($_POST['submit'])) {
    ...
    $sqlinsertinfo = "INSERT INTO `tbl_student`(`user_id`, `std_name`, `std_description`, `std_tel`, `std_email`, `std_address`, 
    `std_dateofbirth`, `std_gender`, `std_races`, `std_course`) VALUES ('$user_id','$name','$description',
   ...
   try {
      ...
      if (file_exists($_FILES["fileToUpload"]["tmp_name"]) || is_uploaded_file($_FILES["fileToUpload"]["tmp_name"])) {
        ...
        echo "<script>window.location.replace('student.php')</script>";
     	...
     	echo "<script>window.location.replace('addStdInfo.php')</script>";
  }
