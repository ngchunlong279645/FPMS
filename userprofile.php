...
if(substr($id, 0, 1) == "C") { 
    $sqluser = "SELECT * FROM tbl_client WHERE user_id = '$id'";
}else if(substr($id, 0, 1) == "L") { 
    $sqluser = "SELECT * FROM tbl_lecturer WHERE user_id = '$id'";
...
<body>
    ...
    <?php
        if(substr($id, 0, 1) == 'C') {
            echo '<img src="../user/client/' . $id . '.png" onerror="this.onerror=null;this.src=\'pic/lecturer.webp\'" >';
        } else if(substr($id, 0, 1) == 'L') {
            echo '<img src="../user/lecturer/' . $id . '.png" onerror="this.onerror=null;this.src=\'pic/lecturer.webp\'" >';
        }
    ?>
    </div>
